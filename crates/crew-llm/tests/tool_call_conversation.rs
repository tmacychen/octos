...
//!
//! Run with:
//!   cargo test -p crew-llm --test tool_call_conversation -- --ignored --nocapture
...
use crew_llm::anthropic::AnthropicProvider;
use crew_llm::gemini::GeminiProvider;
use crew_llm::openai::OpenAIProvider;
use crew_llm::{AdaptiveConfig, AdaptiveRouter, ChatConfig, LlmProvider, ToolSpec};
